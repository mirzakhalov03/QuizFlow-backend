...
router.get('/folders', validateQuery(GetFoldersSchema), folderController.getFolders)
...
router.get(
  '/folders/:id/quizzes',
  validateQuery(GetQuizzesInFolderSchema),
  folderController.getQuizzesInFolder,
)
router.patch(
