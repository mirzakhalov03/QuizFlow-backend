...
export const buildQuizSystemPrompt = (
  ...
  return [
    ...
    '- If a question, option, or explanation contains code or programming code blocks, they MUST be wrapped in triple backticks with the appropriate language (e.g., ```javascript\\n...\\n```) for proper syntax highlighting.',
    '- For inline code snippets within text, wrap them in single backticks (e.g., `code`).',
    '',
    '## Grounding',
